...
func (obj *SSH) Exec() error {
	...
	args := []string{hostname, seeds, file}
	if obj.noop {
	...
	// TODO: consider passing in some sort of depth parameter, in case we
...
func NewRemotes(clientURLs, remoteURLs []string, noop bool, remotes []string, fileWatch chan string, cConns uint16, interactive bool, sshPrivIdRsa string, caching bool, prefix string, converger Converger, convergerCb func(func(map[string]bool) error) (func(), error)) *Remotes {
	return &Remotes{
